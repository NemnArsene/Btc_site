...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20221012_buisnesstradecameroon_198671502579fcc33234_20221013101743_archive.zip';
	const ARCHIVE_SIZE		 = '66059701';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1986715-13101743';
    const SECONDARY_PACKAGE_HASH = '7fc9db6-13101743';
	const VERSION			 = '1.4.4';
