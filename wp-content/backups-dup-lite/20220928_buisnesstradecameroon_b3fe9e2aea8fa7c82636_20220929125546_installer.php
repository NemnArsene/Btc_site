...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220928_buisnesstradecameroon_b3fe9e2aea8fa7c82636_20220929125546_archive.zip';
	const ARCHIVE_SIZE		 = '66012194';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b3fe9e2-29125546';
    const SECONDARY_PACKAGE_HASH = 'e62a49e-29125546';
	const VERSION			 = '1.4.4';
